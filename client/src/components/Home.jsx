...
export default function Home() {
  ...
  return (
    <div>
      ...
      <Link to="/recipe" >
        <button className="buttons" >Create new recipe</button>
      </Link>
      ...
      >
        ...
        <select onChange={(e) => handleSort(e)} className="buttons">
          <option value="">Filter Alphabetically</option>
          <option value="a-z">A-Z</option>
          <option value="z-a">Z-A</option>
        </select>
        <select onChange={(e) => handleByScore(e)} className="buttons">
          <option value="">Filter Score</option>
          <option value="asc">Max-Min</option>
          <option value="des">Min-Max</option>
        </select>

        <select onChange={(e) => handleFilterTypes(e)} className="buttons">
...
export default function Home () {
  ...
  return (
    <div>
      <h1 className='title'> RECIPE APP </h1>
     {/*  <Link to='/recipe'>
        <button id="homeCreate">Create new recipe</button>
      </Link> */}
      <div className='filterContainer'>
        <NavBar />
        <button
        ...
        <select onChange={e => handleByScore(e)} className='homeButton'>
          <option value=''>Filter Score</option>
          <option value='asc'>Max-Min</option>
          <option value='des'>Min-Max</option>
        </select>
